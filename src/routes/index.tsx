...
function Portfolio() {
  ...
  return <div onMouseMove={e => setMouse({ x: e.clientX, y: e.clientY })} className="portfolio-shell relative min-h-screen bg-background">
    ...
    <Hero3D />
    <div className="portfolio-body max-w-screen-xl mx-auto px-6 md:px-12 lg:px-24"><div className="lg:flex lg:gap-16">
      <aside className="portfolio-rail lg:sticky lg:top-0 lg:h-screen lg:w-[45%] lg:flex lg:flex-col lg:justify-between lg:py-24 py-16">
        <div>
      ...
      <main className="portfolio-main lg:w-[55%] lg:py-24 pb-24 space-y-20"><About /><Experience /><Skills /><Certifications /><footer className="portfolio-footer text-xs text-muted-foreground/50 pt-8 border-t border-border/20 leading-relaxed">{t(UI.builtBy, lang)} · {new Date().getFullYear()}</footer></main>
    </div></div>
